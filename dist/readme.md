Below is a **fully rewritten and upgraded documentation (README.md)** for your `image-context` system. It reflects the current implementation, improves clarity, and expands into a **vision-led, contributor-friendly, production-ready doc**.

---

# Image Context

A spatial interaction system for images in React & Next.js.
...
Users discover meaning where it exists, not where layout forces it.

### Precision interaction

Hotspots allow pinpoint-level annotation of visuals.

### ⚡ Lightweight mental model

No complex navigation—just explore the image.

### Composable architecture

Works with React children, render functions, and portals.

### Extensible by design

Custom triggers, AI components, dynamic panels, and overlays.
...
* Tap into Browser native AI engine
