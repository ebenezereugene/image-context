...
const ImageContext = ({ src, alt = "", context, triggerIcon, triggerSize = "md", open = false, showTrigger = true, blurOnOpen = false, imageStyle, children, onVisibleChange, }) => {
    ...
    return (_jsxs("div", { className: styles.contextContainer, children: [_jsx("img", { src: src, alt: alt, className: imageClassName, style: imageStyle }), showTrigger && (_jsxs("div", { ref: triggerGroupRef, className: styles.triggerGroup, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, style: {
